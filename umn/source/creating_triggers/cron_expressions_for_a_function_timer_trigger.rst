...
-  Standard format
   ...
   .. table:: **Table 6** Example cron expressions
      ...
      +==============================================================+============================+
      | 12:00 every day                                              | 0 0 4 \* \* \*             |
      +--------------------------------------------------------------+----------------------------+
      | 12:30 every day                                              | 0 30 4 \* \* \*            |
      +--------------------------------------------------------------+----------------------------+
      | 26th, 29th, and 33rd minutes of each hour                    | 0 26,29,33 \* \* \* \*     |
      +--------------------------------------------------------------+----------------------------+
      | 12:30 from Monday to Friday                                  | 0 30 4 ? \* MON-FRI        |
      +--------------------------------------------------------------+----------------------------+
      | Every 5 minutes during 12:00 and 14:00 from Monday to Friday | 0 0/5 4-6 ? \* MON-FRI     |
      +--------------------------------------------------------------+----------------------------+
      | 12:00 every day from January to April                        | 0 0 4 ? JAN,FEB,MAR,APR \* |
      +--------------------------------------------------------------+----------------------------+
