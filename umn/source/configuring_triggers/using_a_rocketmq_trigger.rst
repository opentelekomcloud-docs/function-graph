...
.. note::
   ...
   -  After VPC access is enabled, you need to configure corresponding subnet permissions for the RocketMQ security group. For details about how to configure VPC access, see :ref:`Configuring Networks <functiongraph_01_0222>`.
